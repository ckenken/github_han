...
public class NewPoint {
	...
	public NewPoint(String inputTime, String inputLat, String inputLng)
	{
		...
		long gmt = Long.parseLong(inputTime.substring(24, 26));
	...
	//	System.out.println(SP[1]);
		...
		int year = Integer.parseInt(SP2[0]) - 1900;  // fix getyear
		int month = Integer.parseInt(SP2[1]) - 1;  // fix getmonth
		...
		time.setTime(time.getTime() + 3600000*gmt);
